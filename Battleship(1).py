...
class Game:
    ...
    def greet(self):
        ...
        print(" Введите random_all, чтобы разместить все оставшиеся корабли случайным образом")
            ...
            while True:
                try:
                    ...
                    if ship[0] == 'random':
                        ...
                        board = Board(self.size)
                        self.player_input()
                    elif ship[0] == 'random_all':
                        self.random_input(lens_int, board)
                        return board
                    else:
    ...
    def random_input(self, lens = [3, 2, 2, 1, 1, 1, 1], board = None):
        if board == None:
